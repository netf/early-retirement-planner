...
export const UK: Jurisdiction = {
  ...
  accounts: [
    { id: "isa", name: "Stocks & Shares ISA", tag: "tax-free · accessible", growthTax: { kind: "none" }, withdrawal: { kind: "free" }, accessAge: null, annualLimit: 20_000, contributionHint: "Allowance £20,000/year", defaults: { balance: 175_000, monthlyContribution: 1_500 } },
    ...
    { id: "cash", name: "Cash", tag: "accessible", growthTax: { kind: "none" }, withdrawal: { kind: "free" }, accessAge: null, isCash: true, defaults: { balance: 25_000, monthlyContribution: 0 } },
  ],
  withdrawalOrder: ["cash", "isa", "gia", "sipp"],
